...
namespace Shopify.Repository
{
    public class SubCategoryService
    {
        ...
        {
            SubCategory result= _db.SubCategories.Include(r=>r.Products.Where(e=>e.IsdeletedBySeller==false)).ThenInclude(r=>r.ProductImages).Where(c => c.SubCategoryId == id && c.Isdeleted == false).FirstOrDefault();
            return result;
        }
